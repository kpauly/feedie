...
3. **Exporteren tab** – Choose what to export:
   ...
   - CSV with date/time/scientific name/lat/lng/path (camera GPS coordinates are prompted once per export). The CSV file format is compatible with [Observation.org](https://observation.org/) bulk import.
